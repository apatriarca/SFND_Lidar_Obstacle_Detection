               ...
               const pcl::PointCloud<pcl::PointXYZI>::Ptr &inputCloud)
{
    ...
    auto filterCloud = pointProcessorI.FilterCloud(inputCloud, 0.3, Eigen::Vector4f(-10.0f, -5.0f, -2.0f, 1), Eigen::Vector4f(30.0f, 7.0f, 1.0f, 1));
    ...
    std::vector<pcl::PointCloud<pcl::PointXYZI>::Ptr> cloudClusters = pointProcessorI.Clustering(segmentCloud.first, 0.6, 6, 500);

    int clusterId = 0;
    std::vector<Color> colors = {Color(1, 0, 0), Color(0, 0, 1), Color(1, 1, 0), Color(1, 0, 1), Color(0, 1, 1)};
...
void simpleHighway(pcl::visualization::PCLVisualizer::Ptr &viewer)
{
    ...
    auto segmentCloud = processor.SegmentPlane(pc, 100, 0.2);
    // renderPointCloud(viewer, segmentCloud.first, "obstCloud", Color(1,0,0));
    renderPointCloud(viewer, segmentCloud.second, "planeCloud", Color(0, 1, 0));
